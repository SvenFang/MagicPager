    ...
    companion object {
        ...
        private fun getWidgets(): BaseWidgetModel {
            ...
            for (i in 0..2) {
                ...
                bg.action =
                    "native.call('magic','show','{\"key\":\"test_ad\",\"type\":\"test\", \"params\":{\"params1\":\"1\",\"params2\":\"1\"}}',function(result) {native.log('sven', 'result->' + result)})"
            }
            widgets.add(frame)
        ...
        private fun getTextModel(
            ...
            text.textHorizontalAlignment = horizontal
            text.text = value
            text.textSize = size
